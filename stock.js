(function () {
  ...
  var BASE = "https://rtgfbovemrxfsiflwmvp.supabase.co/rest/v1/v_public_stock" +
             "?select=app_code,size,finish,qty&qty=gt.0&order=app_code.asc";
  ...
  function css() {
    ...
    s.id = "stk-css";
    s.textContent =
      ".stk-line{margin-top:5px;font-size:11px;font-weight:600;letter-spacing:.02em;color:#4FB07A;display:flex;align-items:center;gap:5px}" +
      ".stk-line:before{content:'';width:6px;height:6px;border-radius:50%;background:#4FB07A;box-shadow:0 0 6px rgba(79,176,122,.8);flex:0 0 6px}" +
      ".stk-line.low{color:#D9A038}" +
      ".stk-line.low:before{background:#D9A038;box-shadow:0 0 6px rgba(217,160,56,.8)}" +
      "#stkSheet{margin:12px 0 2px;font-size:13px;font-weight:600;color:#4FB07A;display:flex;align-items:center;gap:7px}" +
      "#stkSheet:before{content:'';width:7px;height:7px;border-radius:50%;background:#4FB07A;box-shadow:0 0 7px rgba(79,176,122,.85);flex:0 0 7px}" +
      "#stkSheet.low{color:#D9A038}" +
      "#stkSheet.low:before{background:#D9A038;box-shadow:0 0 7px rgba(217,160,56,.85)}" +
